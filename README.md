...
Then read docs/specs/000-template.md and docs/specs/001-repository-ingestion.md.
Act as the Quality Agent.
Write the first failing tests for docs/specs/001 without implementing production code.
```
