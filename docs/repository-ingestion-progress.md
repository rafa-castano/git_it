...
The next batch can begin the query side — expose commit and file fact counts through query service DTOs — or add author-level aggregation from the existing commit facts.
